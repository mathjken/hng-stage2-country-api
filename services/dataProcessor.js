...
async function refreshCountriesData() {
    ...
    for (const country of countryData) {
        ...
        // Ensure population defaults to 0 if undefined, preventing potential issues
        ...
        const countryRecord = {
            ...
            // FIX: Ensure all potential NOT NULL fields have a default value
            capital: country.capital || 'N/A',       
            region: country.region || 'Unknown',     
            population: population,
            
            // FIX: Default rate and GDP to 0 if calculation failed
            exchange_rate: exchange_rate || 0,        
            estimated_gdp: estimated_gdp || 0,        
            
            // FIX: Default flag_url (if NOT NULL in schema)
            flag_url: country.flag || 'N/A',         
            last_refreshed_at: refreshTimestamp,
        };
        
        // FIX: Default currency_code to 'N/A' if null
